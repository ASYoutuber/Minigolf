...
edge = pygame.image.load(os.path.join('Assets', 'sandEdge.png'))
bottom = pygame.image.load(os.path.join('Assets', 'sandBottom.png'))
...
sticky = pygame.image.load(os.path.join('Assets', 'sticky.png'))
coinPics = [pygame.image.load(os.path.join('Assets', 'coin1.png')), pygame.image.load(os.path.join('Assets', 'coin2.png')), pygame.image.load(os.path.join('Assets', 'coin3.png')), pygame.image.load(os.path.join('Assets', 'coin4.png')), pygame.image.load(os.path.join('Assets', 'coin5.png')), pygame.image.load(os.path.join('Assets', 'coin6.png')), pygame.image.load(os.path.join('Assets', 'coin7.png')), pygame.image.load(os.path.join('Assets', 'coin8.png'))]
powerMeter = pygame.image.load(os.path.join('Assets', 'power.png'))
    ...
    while starting:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEMOTION:
                ...
                start_screen.mouseOver(course != None)
            if event.type == pygame.MOUSEBUTTONDOWN:
                pos = pygame.mouse.get_pos()
                if start_screen.click(pos) != None:
                    starting = False
                    break
                if start_screen.shopClick(pos) == True:
